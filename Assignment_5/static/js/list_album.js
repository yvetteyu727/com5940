          ...
          function openForm(recEntry,whichForm) {
              ...
              if (whichForm == 'add') {
                 ...
                 $("#myUpdateForm").modal();
                  ...
                  document.getElementById("upd_quantity").value = recEntry[2];
                  document.getElementById("upd_price").value = recEntry[3];
                  ...
                  document.getElementById("del_quantity").value = recEntry[2];
                  document.getElementById("del_price").value = recEntry[3];
